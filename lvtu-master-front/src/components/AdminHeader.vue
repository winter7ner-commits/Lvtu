<template>
  <header class="header">
    <div class="header-container">
      ...
      <nav class="nav-menu">
        <template v-if="authStore.canAccessAdminOps">
        ...
        <template v-if="authStore.canAccessAuthAudit">
...
const homeRoute = computed(() => authStore.isReviewer ? '/auth-audit' : '/law-management')
