...
create table users (
    ...
    user_type tinyint not null default 1 comment '用户类型：1.普通用户，2.律师，3.平台管理员，4.资质审核员',
...
INSERT INTO users (
    ...
    -- 用户6: reviewer_01 (资质审核员)
    (500006, 'reviewer_01', '$2b$10$1RTvAJcWLmV/fBshcTFf/OgOAHJhigOeo6xTUk0gI6p1Flno78aDu', '13800000006', 'reviewer_01@lvtu.test', NULL, 4, 1, TRUE, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '杭州');
