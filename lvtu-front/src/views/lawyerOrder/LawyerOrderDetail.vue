...
const currentLawyerId = computed(() => {
  try {
    ...
    return userInfo.lawyerId || userInfo.lawyer_id || defaultLawyerId
  } catch {
    return defaultLawyerId
  }
})
...
const handleAccept = async () => {
  try {
    ...
    await acceptLawyerOrder(orderId.value, currentLawyerId.value)
...
const handleSubmitResult = async () => {
  ...
  try {
    await submitServiceResult(orderId.value, {
      lawyerId: currentLawyerId.value,
